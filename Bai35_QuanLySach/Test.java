...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        TacGia tacGia1 = new TacGia("Kas", ngay1);
        TacGia tacGia2 = new TacGia("20215455", ngay2);
        TacGia tacGia3 = new TacGia("Eru", ngay3);
        ...
        System.out.println("So sanh NXB sach 2 va 3: "+sach2.kiemTraCungNamXuatBan(sach3));
